...
from .views import CreateUserView ,ProfileUserView, ChangePasswordView, GoogleLogin, GoogleLoginCallback
...
urlpatterns = [
    ...
    path('user/auth/google/callback/',GoogleLoginCallback.as_view(), name='google_callback'),
