...
from .views import CreateUserView ,ProfileUserView,LogoutView, ChangePasswordView, PasswordResetView,PasswordResetConfirmView, CustomTokenObtainPairView, CustomTokenRefreshView,EmailVerificationView
